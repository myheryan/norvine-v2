...
import { displayStatus, formatDate, formatPhoneNumber } from "@/lib/utils";
        ...
        <div className="bg-white p-3 border-t-4 border-surel">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
            <div className="md:col-span-4">
              ...
              <p className="font-bold text-[13px] flex gap-3 items-center">
                  <span>{order.shippingAddress?.recipientName}</span>
                  <span className=" text-[12px]">{formatPhoneNumber(order.shippingAddress?.recipientPhone)}</span>
              </p>
