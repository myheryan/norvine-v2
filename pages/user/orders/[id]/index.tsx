        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-white w-full max-w-md rounded-none shadow-2xl relative overflow-hidden animate-in fade-in zoom-in duration-200">
            <div className="border-b border-gray-100 p-5 flex items-center justify-between bg-white">
              <h2 className="text-[11px] font-black text-zinc-900">Ajukan Pembatalan</h2>
            ...
            <div className="p-6 space-y-5">
              <div className="flex items-start gap-3 bg-zinc-50 p-4 border border-zinc-100">
                ...
                <div className="space-y-1">
                  <p className="text-[10px] font-black text-zinc-900">Penting</p>
                  <p className="text-[10px] text-zinc-500 leading-relaxed">Dana dikembalikan setelah Admin menyetujui pengajuan. Proses verifikasi 1-3 hari kerja.</p>
                </div>
              </div>
              <div className="space-y-2">
                <p className="text-[9px] font-black text-zinc-400 mb-3">Pilih Alasan :</p>
                {REFUND_REASONS.map((r) => (
                  <label key={r} className={`flex items-center gap-3 p-4 border transition-all cursor-pointer ${selectedReason === r ? 'border-zinc-900 bg-zinc-50' : 'border-gray-100 hover:bg-gray-50'}`}>
                    ...
                    <span className="text-[11px] font-bold text-gray-700  tracking-tight">{r}</span>
                  </label>
                ))}
              </div>
            </div>
            <div className="p-6 pt-0">
              <button onClick={handleRefundSubmit} disabled={isSubmittingRefund || !selectedReason} className="w-full py-4 bg-zinc-900 text-white font-black text-[12px] tracking-[0.3em] disabled:opacity-20 transition-all">
